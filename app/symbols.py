...
_NOISE_WORDS = {
    ...
    "AM", "PM", "UP", "DOWN", "GAINER", "GAINERS", "LOSER", "LOSERS", "VS", "PRICE",
    "CHART", "TRADINGVIEW", "F&O", "FO", "LEADING", "RANK", "FALL", "FALLING", "RISING",
    "BULLISH", "BEARISH", "SCAN", "SCANS", "LIVE", "INTRADAY", "DN",
}
